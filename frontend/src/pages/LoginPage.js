      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8 animate-fade-in">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link to="/register" className="text-primary font-medium hover:underline" data-testid="go-to-register">
              Create one
            </Link>
          </p>
        </div>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-slate-50 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center p-12 max-w-lg">
          ...
          <p className="text-base text-slate-600 leading-relaxed">
            Transform any idea into polished, professional slides in seconds. Powered by three specialized AI models.
          </p>
        </div>
      </div>
    </div>
